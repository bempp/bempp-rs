...
fn _compute_transfer_vectors_new() -> Vec<TransferVector> {
    let mut result: Vec<TransferVector> = Vec::new();
    ...
    // Encode point in centre of domain
    let key = MortonKey::from_point(&point, &domain, 2);
...
// #[cfg(test)]
// mod test {
//     use crate::transfer_vector::compute_transfer_vectors;

//     use super::compute_transfer_vectors_new;

//     #[test]
//     fn test_transfer_vector() {
//         let t1 = compute_transfer_vectors();
//         let t2 = compute_transfer_vectors_new();

//         for i in 0..316 {
//             println!("i={:?} t1 {:?} t2 {:?}", i, t1[i].components, t2[i].components);
//         }
//         assert!(false);
//     }
// }
