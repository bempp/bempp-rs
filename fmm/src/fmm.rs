...
use bempp_field::{
    fft::Fft,
    types::{FftFieldTranslationKiFmmNew, SvdFieldTranslationKiFmm},
};
...
use bempp_traits::{
    ...
    fmm::{Fmm, FmmLoop, NewFmm, SourceTranslation, TargetTranslation, TimeDict},
...
//     #[allow(clippy::too_many_arguments)]
//     fn test_uniform_matrix_f64_rcmp(
//         order: usize,
//         alpha_inner: f64,
//         alpha_outer: f64,
//         depth: u64,
