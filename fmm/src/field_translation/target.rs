            ...
            parent_locals
                ...
                .for_each(|(parent_local_pointers, child_locals_pointers)| {
                    let mut parent_locals =
                        rlst_dynamic_mat![V, (self.ncoeffs, self.ncharge_vectors)];
