...
use rlst::{common::traits::ColumnMajorIterator, dense::{rlst_rand_mat, RawAccess}};
...
use bempp_tree::{types::single_node::SingleNodeTree, implementations::helpers::points_fixture};
use bempp_traits::{tree::Tree, fmm::FmmLoop};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("fft laplace order=9 depth=5 npoints=1e6", |b| b.iter(|| fft_fmm(1000000, 9, 5)));
}
