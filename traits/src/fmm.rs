...
pub trait SourceDataTree {
    ...
    fn get_multipole_expansion(&self, key:  &<<Self::DataTree as AttachedDataTree>::Tree as Tree>::NodeIndex);

    fn set_multipole_expansion(&self, key:  &<<Self::DataTree as AttachedDataTree>::Tree as Tree>::NodeIndex);
...
pub trait TargetDataTree {
    ...
    fn get_local_expansion(&self, key:  &<<Self::DataTree as AttachedDataTree>::Tree as Tree>::NodeIndex);

    fn set_local_expansion(&self, key:  &<<Self::DataTree as AttachedDataTree>::Tree as Tree>::NodeIndex);
