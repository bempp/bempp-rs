...
pub trait Kernel<T: Num> {
    ...
    fn shared_edge_kernel(&self, result: &mut [T], test_vertices: &[T], trial_vertices: &[T], qid: usize);
    fn shared_vertex_kernel(&self, result: &mut [T], test_vertices: &[T], trial_vertices: &[T], qid: usize);
