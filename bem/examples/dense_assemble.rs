    ...
    for test_cell in 0..grid.geometry().cell_count() {
        ...
        for trial_cell in 0..grid.geometry().cell_count() {
            ...
            if pairs.len() == 0 {
                ...
                let mut test_table = element.create_tabulate_array(0, test_rule.npoints);
                let mut trial_table = element.create_tabulate_array(0, trial_rule.npoints);
                ...
                let mut test_table = element.create_tabulate_array(0, singular_rule.npoints);
                let mut trial_table = element.create_tabulate_array(0, singular_rule.npoints);
