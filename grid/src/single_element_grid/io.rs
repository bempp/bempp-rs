...
use bempp_traits::{grid::GmshIO, element::FiniteElement};
use num::Float;
use rlst_dense::{
    ...
    fn to_gmsh_string(&self) -> String {
        ...
        for i in 0..node_count {
            for n in 0..3 {
                ...
                gmsh_s.push_str(&format!("{}", self.geometry.coordinates.get([i, n]).unwrap()));
            }
            gmsh_s.push('\n');
        }
        ...
        for i in 0..cell_count {
            ...
            for j in get_permutation_to_gmsh(cell_type, degree) {
